...
class Elementor_Notice_Widget extends \Elementor\Widget_Base
{
	...
	{ ?>
		<div class="card">
			...
			<div class="card__fieldset"><button type="button" class="button is-primary"><?php echo __('Edit Project ID', 'noticefaq') ?></button></div>
		</div>
	<?php
	}
	...
	{ ?>
		<div class="card">
			...
			<div class="card__instructions"><?php echo __('Your Notice project is loaded and will be visible and interactive on the public/preview page.', 'noticefaq') ?></div>
		</div>
<?php
	}
